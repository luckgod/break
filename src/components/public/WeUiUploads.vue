<template>
    ...
    <div class="weui-upload">
                                ...
                                :class="{'weui-uploader__file_status':item.indexOf('base64') !== -1}"
                                 v-for="(item,index) in images">
                                    <img :src="item" @click="previewImage(index,item)"
                                         ...
                                         onerror="onerror=null;src='http://p3.gexing.com/G1/M00/EC/50/rBACJ1buO1LSPHLTAAAXL4Rtdlc29_200x200_3.jpeg?recache=20131108'">
        ...
        <!--图片预览-->
        <div class="weui-gallery" v-show="img.is_preview" >
            ...
            <div class="weui-gallery__opr">
                <a href="javascript:" class="weui-gallery__del" @click.prevent="deleteImage(img.image_index);hidePreview()" style="display: inline-block;margin-right: 20px;">
                    <i class="weui-icon-delete weui-icon_gallery-delete"></i>
                    <span class="weui-span_del">删除</span>
                </a>
                <a href="javascript:" class="weui-gallery__del" @click.prevent="rotate()" style="display: inline-block">
