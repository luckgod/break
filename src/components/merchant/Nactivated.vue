        ...
        <div>
            ...
            <el-form :model="form"
                ...
                <el-form-item label="商家营业时间：" label-width="150px" style="margin-top: 25px;">          
                 ...
                 <el-form-item label="当面付让利比例：" v-if="form.storeRebate">
                     <span>{{form.storeRebate *100}}%</span>
                </el-form-item>
                <el-form-item label="商家类型：">
                     <el-select v-model="form.storeType" style="width: 200px;" :disabled="true">
                ...
                <el-form-item label="">
                   <el-button type="primary" :loading="loading" @click="submitForm()" v-if="form.actStat==3">保存</el-button> 
                </el-form-item>
            ...
            <el-form  label-width="100px" class="demo-ruleForm" style="display:inline-block;;max-width:600px" :model="form" >
                <el-form-item label="认证图片：">
                    <div style="display:inline-block;text-align: center">
                        <div>
                           <img :src="form.personPhoto" alt=""  class="img-preview" @click="previewIdCard(form.personPhoto,0)" style="margin-right: 10px;" > 
                        </div> 
                        （手持身份证正面）
                    </div>      
                    <div style="display:inline-block;text-align: center">
                        <div>
                           <img :src="form.idcardFront" alt=""  class="img-preview" @click="previewIdCard(form.idcardFront,1)" style="margin-right: 10px;" > 
                        </div> 
                      （身份证正面） 
                    </div>
                    <div style="display:inline-block;text-align: center">
                        <div>
                           <img :src="form.idcardBack" alt=""  class="img-preview" @click="previewIdCard(form.idcardBack,2)" style="margin-right: 10px;" > 
                        </div> 
                      （身份证反面） 
                    </div>
                    <br>
                    <div style="display:inline-block;text-align: center;margin-left: 10px;">
                       <div>
                           <img :src="form.businessLicense" alt=""  class="img-preview" @click="previewIdCard(form.businessLicense,3)"> 
                        </div>
                        （营业执照）
                    </div>
                ...
                <el-form-item label="商家简介图：">
                    <we-ui-uploads :images="form.storegList"
                                   :maxCount="9"
                                   :maxSize="1024*1024"
                                   :isSort="true"
                                   @uploading="uploading"></we-ui-uploads>
...
<script>
    export default {
        ...
        methods: {
            fetchData(){
                this.dataApi.ajax('getStoreApplyActivation', {storeId: this.$route.params.id}, res => {
