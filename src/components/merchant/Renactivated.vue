            ...
            <div v-show="firstStep">
                ...
                <el-form label-width="150px" class="demo-ruleForm" :model="form1" style="display: inline-block;margin-right: 40px;vertical-align: top;">
                    ...
                    <el-form-item label="联系方式：">
                        <el-input style="width: 300px;" v-model="form1.contactNum" :maxlength="50" :disabled="disabled1"></el-input>
                    </el-form-item>
...
<!--                 <el-row>
                    <el-col :span="24">
                        <el-button
                                type="primary"
                                @click="firstStep=true;secondStep=false">返回
                        </el-button>
               ...
               <!--  <el-row>
                ...
                <el-form :model="form3"
                    ...
                    <el-form-item label="商家类型：">
                         <el-select v-model="form3.storeType" style="width: 200px;" :disabled="form.actStat!=0">
        ...
        methods: {
            fetchData(){
                this.dataApi.ajax('getStoreApplyActivation',{applyId: this.$route.params.id}, res => {
                    if (res.responseType === 'S') {
                                ...
                                this.id=res.userId
                                this.userName=res.signedName
                                this.form1.province=Math.floor(res.areaNum/10000)*10000+''
                                this.form1.city=Math.floor(res.areaNum/100)*100+''
                                this.form1.area=res.areaNum+''
                                this.form1.contact=res.contact
                                this.form1.idCard=res.idCard
                                this.form1.contactNum=res.contactNum
                                this.form1.storeId=res.storeId
                                this.form2={
                                   personPhoto:[res.personPhoto],
                                ...
                                this.form3={
                                    ...
                                    businessTime:res.businessTime,
                                    businessClass:res.businessClass,
                                    businessSubclass:res.businessSubclass,
                                    introduction:res.introduction,
                                    businessLicense: [res.businessLicense],
                                    storegList:res.storegList,
                                    storeImg:[res.storeImg],
                                    storeAccu:res.storeAccu,
                                    storeDime:res.storeDime,
                                    storeType:res.storeType
                                }
                                 if (this.form3.businessTime!='') {
                                    this.startTime=this.form3.businessTime.split('-')[0]
                                    this.endTime=this.form3.businessTime.split('-')[1] 
                                 }else{
                                    this.startTime=''
                                    this.endTime=''
                                 }
                    ...
                    this.dataApi.ajax('selectSysCity', {cityCode: parentCode}, res => {
                        if (res.responseType === 'S') {
                               this[type] = res.dtos
                                if (rank === 1) {
                                     if (this.notSelect) {
                                        this.form1.city= this.form1.city
                                        this.form1.area= this.form1.area
            ...
            checkFirst(){
                ...
                if (!this.form1.contact) {
                    this.showMsg('请填写带店主/经办人姓名','warning')
                    return false;
                }
                if (!this.form1.idCard) {
                    this.showMsg('请填写法人身份证','warning')
                    return false;
                }
