<template>
    <div class="customer">
        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline" label-width="100px" v-show="activeName==1">
            <el-form-item label="按套餐名称:">
                <el-input v-model="formInline.voucherName" style="width: 150px;" :maxlength="50"></el-input>
            </el-form-item>
            <el-form-item label="按状态：">
                <el-select v-model="formInline.voucherStat" style="width: 120px;" >
        ...
        <el-table
            ...
            <el-table-column label="操作" width="140">
                <template scope="scope">
                    <el-button type="primary" size="small" @click="$router.push('/merchant/combo_detail/'+scope.row.voucherId)">编辑</el-button>
    ...
    export default {
        ...
        methods: {
            fetchData (page = 1) {
                ...
                this.dataApi.ajax('selectPagePayStoreVoucher',this.formInline, res => {
