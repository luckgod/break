<template>
    <div class="account" >
        <el-row :span="24" style="margin:26px 0 0;">
            ...
            <el-button type="warning">优惠套餐</el-button>
        ...
        <el-table
            ...
            <el-table-column
                    ...
                    <template scope="scope">
                        ...
                        <span  class="pointer" @click="$router.push('/order/discounts_detail/'+scope.row.transferId)">订单详情</span>
    ...
    export default {
        ...
        methods: {
            fetchData (page=1) {
             ...
             fetchNumber () {
                this.dataApi.ajax('countPagePayFaceTransfer',{goodType:2}, res => {
                    if (res.responseType === 'S') {
